...
export default function InventoryPage() {
    return (
        ...
        <main className="min-h-screen bg-slate-50/50 pb-28 max-w-md mx-auto relative">
            <header className="sticky top-0 z-20 pt-6 pb-4 px-4 bg-slate-50/80 backdrop-blur-xl mb-2 border-b border-slate-200/50 flex items-center justify-between gap-3">
