...
export default function StatsPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 pb-28 max-w-md mx-auto relative">
            <header className="sticky top-0 z-20 pt-6 pb-4 pl-4 pr-16 bg-slate-50/80 backdrop-blur-xl mb-4 border-b border-slate-200/50 flex items-center justify-between">
